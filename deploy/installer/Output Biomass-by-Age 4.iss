...
#define ExtensionName "Output Biomass By Age"
...
AppId={{81128ABC-EDB5-4A4C-B011-D9E3C1B4A376}
...
Source: {#BuildDir}\Landis.Extension.Output.BiomassByAge-v4.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Output Biomass-by-Age 4.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Output Biomass-by-Age"" "; WorkingDir: {#LandisPlugInDir}
